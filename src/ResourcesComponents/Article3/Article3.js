...
export default function Article3() {
  return (
    <div className="article-container">
      <h1 className="article-header color-red">What if I receive a 'say hi' from someone I <span className="italic">know</span> & I am not interested in...</h1>
