  ...
  return (
    <div className="article-container">
      ...
      <div className="article-content text-align-justify color-blue">
        ...
        <p>Great questions. We’re glad you asked! First, remember that saying ‘hi’ is simply that - sending a greeting. Responding to a ‘hi’ notification is not committing to dating, it is simply a gesture of two human beings beginning a conversation unto a potential friendship. At MatchesUp we always promote friendship first, as that is the best way to get to know one another and establish a healthy foundation moving forward. Because of this principle, we would suggest that it is absolutely fine to have conversations with more than one person. Imagine yourself at a party, being introduced to many different people, starting many potential friendships. Over time, one of them might become more significant to you, but at first you just have to spend time getting to know people. I mean think about it, you’re on a MatchesUp site - so both parties understand that you are both searching for the specific qualities you want in a life partner but neither of you wants to commit too early before you really know one another. It’s good to pursue friendship first! It takes the pressure off and is a great way to expand your social circle.</p>
