  ...
  return (
    <div className="article-container">
      ...
      <div className="article-content text-align-justify color-blue">
        ...
        <div>
          <div className="padding-left-20">🡪 Hi. I received your ‘hi’ on MatchesUp. Your profile also looks interesting to me, maybe we should chat a bit more.</div>
          <div className="padding-left-20">🡪 Thanks for sending a ‘hi’ from the MatchesUp site. I also took a look at your profile and had a couple of questions…  (<span className="italic">proceed to ask your questions</span>).</div>
          <div className="padding-left-20">🡪 Hello. Thanks for your interest in my profile. Maybe we could set up a zoom call later this week to get to know one another as friends first.</div>
        </div>
        <br />
        ...
        <div>
          <div className="padding-left-20">🡪 Thanks so much for your ‘hi’ on MatchesUp. I’m honored you liked my profile. This isn’t about you, but I am not available at the moment to pursue further conversation. If things change, I’ll get back to you. Thanks again for your interest.</div>
          <div className="padding-left-20">🡪 I just wanted to acknowledge the notification I received that you liked my profile. While I’m honored, this is not something I feel to pursue at this time. I wish you all the best in your search for who God has for you.</div>
        </div>
        <br />
